...
#Region "Boton Aceptar"
    Private Sub cmdAceptar_Click(sender As System.Object, e As System.EventArgs) Handles cmdAceptar.Click
        ...
        For i = 0 To grlGrillaa.Rows.Count - 1

            oFacturaDetalle.AgregarFacturaDetalle(resultado, grlGrillaa.Rows(i).Cells(0).Value, grlGrillaa.Rows(i).Cells(1).Value, grlGrillaa.Rows(i).Cells(2).Value, grlGrillaa.Rows(i).Cells(3).Value)
